...
function goToBlockInfosByNumber() {
    $.ajax(
        {
            url: 'http://54.92.124.121:7000/v1/block?number=' + keyValue,
            type: 'get',
            async: false,
            dataType: 'json',
...
function goToBlockInfosByHash() {
    ...
    $.ajax(
        {
            url: 'http://54.92.124.121:7000/v1/block?hash=' + keyValue,
            type: 'get',
            async: false,
            dataType: 'json',
            beforeSend: function (xhr) {
...
function goToTxInfos() {
    $.ajax(
        {
            url: 'http://54.92.124.121:7000/v1/transaction?hash=' + keyValue,
            type: 'get',
            async: false,
            dataType: 'json',
            beforeSend: function (xhr) {
